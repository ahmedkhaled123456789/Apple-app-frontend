    ...
    <>
      <div
        ...
        style={{
          ...
          backgroundColor: "rgb(231, 236, 238)",
          minHeight: "100vh",
        }}
      >
        <Container>
                  ...
                  <div className="col-12 mb-5" key={p.id}>
                    <Row className="align-items-center">
                      ...
                      <div className="col-12 col-md-8">
                        <Row>
                          <div className="col-12 col-md-4 text-center mb-4 mb-md-0 cartText">
                            <h4>{p.name}</h4>
                          </div>
                          <div className="col-12 col-md-4 text-center mb-4 mb-md-0 cartText">
                            <h4>{p.quantaty}</h4>
                          ...
                          <div className="col-12 col-md-10 mt-md-4 text-center text-md-end">
                            <button
                              className="remove"
          ...
          {product && (
            <Container className="mt-4">
              <Row>
                <div
                  className="col-6 text-center mb-4 fs-5"
                ...
                <div
                  className="col-6 text-center fs-5"
                  style={{ fontWeight: "600" }}
                >
                  Shipping
                </div>
