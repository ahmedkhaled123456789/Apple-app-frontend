...
export default function Products(props) {
  ...
  const handleProducts = (catName) => {
    ...
    const productsFilter =
      catName === "all"
        ? data
        : data.filter((product) => product.type === catName);
      ...
      >
        <Container>
          <div className="button w-100 text-center">
            <button
              className={product === "all" ? "yes" : ""}
              onClick={() => handleProducts("all")}
            >
              All
            </button>
            <button
              className={product === "mac" ? "yes" : ""}
              onClick={() => handleProducts("mac")}
            >
              Mac
            </button>
            <button
              className={product === "iphone" ? "yes" : ""}
              onClick={() => handleProducts("iphone")}
            >
              Iphone
            </button>
            <button
              className={product === "watch" ? "yes" : ""}
              onClick={() => handleProducts("watch")}
            >
              Watch
            </button>
            <button
              className={product === "ipad" ? "yes" : ""}
              onClick={() => handleProducts("ipad")}
            >
              Ipad
            </button>
          </div>
                    ...
                    <Card.Body>
                      <Row className="align-items-center">
                        ...
                        <div className="col-4 text-end">
                          <h1 onClick={() => dispatch(addToCart(product))}>
                            <button>
